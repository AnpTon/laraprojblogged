    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form id="search-form" action="{{ route('posts.searchResults') }}" method="GET">
                        <div class="mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                <label for="tag-input" class="block text-sm font-medium text-gray-700 mb-1">Tags (Optional)</label>
                                <div class="relative">
...
@foreach($selectedTags as $tag)
                                ...
                                <input type="hidden" name="tags" id="tags-hidden" value="{{ json_encode($selectedTags) }}">
                            </div>
                        </div>
            ...
            @if(isset($posts))
                <div class="mt-6">
                    <h3 class="text-lg font-semibold mb-4">Results ({{ $posts->count() }})</h3>
                    @if($posts->isEmpty())
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                            ...
                            @foreach($posts as $post)
                                <a href="{{ route('posts.show', $post) }}" class="block bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition-shadow cursor-pointer">
                                    <div class="p-6">
                                        ...
                                        <p class="text-gray-600 text-sm mb-2">{{ Str::limit($post->body, 150) }}</p>
